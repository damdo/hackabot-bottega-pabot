...
dev:
	...
	docker run --rm -it -e BOT_TOKEN=539020128:AAGdBDE0b3BYa51R-qem7Xxlr1wT0Af8io8 -v "$(PWD):/usr/src/app" --link tgbot-dash:tgbot-dash --link tgbot-nlp-backend:tgbot-nlp-backend --name tgbot-hackabot-dev  damdo/tgbot-hackabot-dev;
