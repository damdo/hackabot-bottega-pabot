...
def regular_choice(bot, update, user_data):
    ...
    update.message.reply_text( 'Bene :) Hai scelto DOMANDA LIBERA, scrivimi pure qui sotto quello che stai cercando, faro\' del mio meglio per aiutarti!')
...
def custom_choice(bot, update, user_data):
    ...
    update.message.reply_text('Bene :) Hai scelto SFOGLIA PER CATEGORIE, guarda i pulsanti delle categorie qui sotto e scegli quella piu\' pertinente alle tue necessita\'', reply_markup=cat_keyboard)
...
def received_information(bot, update, user_data):
    ...
    print type(response_procedures)
